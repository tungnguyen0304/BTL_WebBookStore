...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Clean and validate input data. Returns an error list if the data is invalid.
    ...
    if (!empty($errors)) {
        ...
        $qry = "INSERT INTO product (name, unique_name, categoryID, image, price, current_qty, sold_qty, authorID, manufacturerID, description)
                VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
